...
CREATE TABLE `student_teacher` (
  ...
  CONSTRAINT `student_teacher_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`),
  CONSTRAINT `student_teacher_ibfk_2` FOREIGN KEY (`teacher_id`) REFERENCES `users` (`id`)
...
INSERT INTO `student_teacher` VALUES (73,12),(70,13),(73,13),(74,13),(73,14),(74,14),(73,15),(74,15),(73,17),(74,17),(73,18),(74,18);
